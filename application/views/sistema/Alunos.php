...
<body class="">
  ...
  <canvas id="bigDashboardChart"></canvas>
      ...
      <div class="content">
        <div class="w-100">
        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#ModalCadastroCliente">Adicionar Aluno</button>
     ...
     <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
              <?php if ($this->session->flashdata("NovoAlunoSucesso")) { ?>
